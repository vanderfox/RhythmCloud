...
public class TemporalAnalyzerConstruct extends Construct {
    ...
    public TemporalAnalyzerConstruct(final Construct scope,
                                     final String id,
        ...
        PolicyStatement kinesisWriterPolicyStatement = PolicyStatement.Builder.create()
                .sid("KinesisWriter")
                .effect(Effect.ALLOW)
                .actions(Arrays.asList("kinesis:DescribeStream", "kinesis:PutRecord", "kinesis:PutRecords"))
                .resources(Collections.singletonList(props.getRhythmCloudAnalysisOutputStream().getAttrArn()))
                .build();

        PolicyStatement kinesisReaderPolicyStatement = PolicyStatement.Builder.create()
                .sid("KinesisReader")
                .effect(Effect.ALLOW)
                .actions(Arrays.asList("kinesis:DescribeStream", "kinesis:GetShardIterator", "kinesis:GetRecords"))
        ...
        PolicyStatement cloudWatchAnalyzerPolicyStatement = PolicyStatement.Builder.create()
                .sid("CloudWatchAnalyzer")
                .effect(Effect.ALLOW)
                .actions(Arrays.asList("logs:DescribeLogGroups", "logs:DescribeLogStreams", "logs:PutLogEvents"))
                .resources(Collections.singletonList(String.format(
        ...
        CfnApplicationV2.PropertyGroupProperty systemHitPropertyGroup = CfnApplicationV2.PropertyGroupProperty.builder()
        ...
        CfnApplicationV2.PropertyGroupProperty userHitPropertyGroup = CfnApplicationV2.PropertyGroupProperty.builder()
        ...
        CfnApplicationV2.ApplicationConfigurationProperty applicationConfigurationProperty = CfnApplicationV2.ApplicationConfigurationProperty.builder()
                .applicationSnapshotConfiguration(CfnApplicationV2.ApplicationSnapshotConfigurationProperty.builder()
                        ...
                        .build())
                .applicationCodeConfiguration(CfnApplicationV2.ApplicationCodeConfigurationProperty.builder()
                        .codeContent(CfnApplicationV2.CodeContentProperty.builder()
                                .s3ContentLocation(CfnApplicationV2.S3ContentLocationProperty.builder()
                        ...
                        .build())
                .flinkApplicationConfiguration(CfnApplicationV2.FlinkApplicationConfigurationProperty.builder()
                        .parallelismConfiguration(CfnApplicationV2.ParallelismConfigurationProperty.builder()
                                .autoScalingEnabled(true)
                                .parallelism(2)
                                .parallelismPerKpu(1)
                                .configurationType("CUSTOM")
                                .build())
                        .monitoringConfiguration(CfnApplicationV2.MonitoringConfigurationProperty.builder()
                                .logLevel("INFO")
                                .metricsLevel("TASK")
                                .configurationType("CUSTOM")
                                .build())
        ...
        rhythmAnalyzerApplication = CfnApplicationV2.Builder.create(this, "rhythm-analyzer")
